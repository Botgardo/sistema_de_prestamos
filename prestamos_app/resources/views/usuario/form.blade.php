<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="departamento" class="form-control @error('departamento') is-invalid @enderror" value="{{ old('departamento', $usuario?->departamento) }}" id="departamento" placeholder="Departamento">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="tipo_usuario" class="form-control @error('tipo_usuario') is-invalid @enderror" value="{{ old('tipo_usuario', $usuario?->tipo_usuario) }}" id="tipo_usuario" placeholder="Tipo Usuario">
