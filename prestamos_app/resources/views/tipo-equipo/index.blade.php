										...
										<td >{{ $tipoEquipo->descripcion }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('tipo-equipos.destroy', $tipoEquipo->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('tipo-equipos.show', $tipoEquipo->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('tipo-equipos.edit', $tipoEquipo->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
